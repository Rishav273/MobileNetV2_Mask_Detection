...
logger.info("Appending images and labels...")
...
logger.info("Binarizing categories...")
...
logger.info("Loading base mobilenet network...")
...
logger.info("Replacing final layers and compiling network...")
